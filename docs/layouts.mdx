---
title: Layouts
description: Use pre-defined layouts with the LayoutManager to render text, cards, and bitmaps on smart glasses in MentraOS Cloud. Includes APIs, options like duration and view, utilities, and best practices.
---
