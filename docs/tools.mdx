---
title: AI Tools
description: Define and handle AI Tools for MentraOS apps. Learn how to declare tools in the developer console, specify parameters, and implement onToolCall handlers with practical examples.
---
