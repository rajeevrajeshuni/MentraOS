---
title: App Lifecycle
description: Understand how a MentraOS app registers, initializes a session, connects to the cloud, subscribes to events, updates the display, and terminates cleanly.
---
