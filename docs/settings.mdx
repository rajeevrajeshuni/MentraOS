---
title: Settings
description: Learn how to define and use app settings in MentraOS—supported types, real-time synchronization, access patterns, and best practices with code examples.
---
