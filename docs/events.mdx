---
title: "Events"
description: "Subscribe to MentraOS Cloud real-time events (transcription, head position, button presses, notifications, battery, and more) using the EventManager. Learn how to subscribe/unsubscribe and review all event types with their data structures."
---
