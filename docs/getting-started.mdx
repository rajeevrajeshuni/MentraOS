...
description: "Step-by-step guide to build your first MentraOS app from scratch: set up your project, install the SDK, configure environment variables, register your app, expose it with ngrok, and run it on smart glasses."
---
