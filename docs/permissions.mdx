---
title: Permissions
description: Learn how MentraOS permissions work, the available permission types, how to declare them for your app, and how enforcement and best practices ensure user privacy and transparency.
---
