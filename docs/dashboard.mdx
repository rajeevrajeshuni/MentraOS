---
title: Dashboard
description: "Use the MentraOS Dashboard (a persistent, glanceable surface) to show app status and content. Write content via session.dashboard.content.writeToMain()."
---
