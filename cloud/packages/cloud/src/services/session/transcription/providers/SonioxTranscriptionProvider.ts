...
export class SonioxTranscriptionProvider implements TranscriptionProvider {
  ...
  validateLanguagePair(source: string, target: string): boolean {
    ...
    const supportedPairs = new Map([
      ...
      [
        "es-ES",
        ["en-US", "es-US", "es-MX", "fr-FR", "de-DE", "it-IT", "pt-BR"],
      ],
      [
        "es-US",
        ["en-US", "es-ES", "es-MX", "fr-FR", "de-DE", "it-IT", "pt-BR"],
      ],
      [
        "es-MX",
        ["en-US", "es-ES", "es-US", "fr-FR", "de-DE", "it-IT", "pt-BR"],
      ],
      [
        "fr-FR",
        ["en-US", "es-ES", "es-US", "es-MX", "de-DE", "it-IT", "pt-BR"],
      ],
      [
        "de-DE",
        ["en-US", "es-ES", "es-US", "es-MX", "fr-FR", "it-IT", "pt-BR"],
      ],
    ...
    return (
      !!(targetLanguages && targetLanguages.includes(target)) ||
