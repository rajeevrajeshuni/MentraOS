 ...
 */
RAM_ALIGN const int16_t ldCoeff[7] = {-32768, -16384, -10923, -8192, -6554, -5461, -4681};
...
*/
const uint32_t exp2_tab_long_lc3[32] = {
...
*/
const uint32_t exp2w_tab_long_lc3[32] = {
...
*/
const uint32_t exp2x_tab_long_lc3[32] = {
...
const int16_t SqrtDiffTable[32] = {
    /* Q21 */
...
const int16_t ISqrtDiffTable[32] = {
    /* Q21 */
...
const PWord16 SineWindow120_1[60] = {
...
const PWord16 SineWindow128_1[64] = {
...
const PWord16 SineWindow480_1[240] = {
...
void LC3_getTables(const PWord16 **twiddle, const PWord16 **sin, int16_t *sin_step, int16_t length)
{
    switch (length)
    {
    case 20:
...
const int32_t RealFFT64_twid[18] = {
...
const int32_t RealFFT80_twid[22] = {
...
const int32_t RealFFT96_twid[26] = {
...
const int32_t RealFFT128_twid[34] = {
...
const int32_t RealFFT192_twid[50] = {
...
const int32_t RealFFT256_twid[66] = {
...
const int32_t RealFFT384_twid[98] = {
...
const int32_t RealFFT512_twid[130] = {
...
const int32_t RealFFT768_twid[194] = {
...
const int32_t RotVector_32_32[2 * 20] = {
...
const int32_t RotVector_40_32[2 * 28] = {
...
const int16_t RotVector_480[2 * (480 - 30)] = {
...
const int16_t RotVector_320[2 * (320 - 20)] = {
...
const int16_t RotVector_32_8[2 * (256 - 32)] = {
...
const int16_t RotVector_32_12[2 * (384 - 32)] = {
...
/* Inverse square root table for operands running from 0.5 to ~1.0
   ...
   (int32_t) (0.5 + 1.0/sqrt((op)/CDKpow(2.0,31)))
...
*/
const int32_t isqrt_table[128 + 2] = {
...
const int32_t Log2_16_table1[16] = {
...
const int16_t InvLog2_16_table2[64] = {
...
const uint8_t rs16_elp_deg2_table[256] = {
...
const uint16_t rs16_elp_deg3_table[256] = {
