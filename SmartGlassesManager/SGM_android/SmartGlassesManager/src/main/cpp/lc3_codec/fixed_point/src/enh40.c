 ...
 *
 *****************************************************************************/
static __inline int64_t L40_shr(   int64_t L40_var1, int16_t var2);
static __inline int64_t L40_shl(   int64_t L40_var1, int16_t var2);
static __inline int64_t L40_set( int64_t L40_var1);
static __inline uint16_t Extract40_L( int64_t L40_var1);
static __inline int64_t L40_mult( int16_t var1, int16_t var2);
static __inline int64_t L40_add( int64_t L40_var1, int64_t L40_var2);
static __inline int64_t L40_mac( int64_t L40_var1, int16_t var2, int16_t var3);
static __inline uint32_t L_Extract40( int64_t L40_var1) ;
 ...
 *  Outputs :
 *
 *    *L_varout_h 32 bit long signed integer (int32_t) whose value falls in
...
void Mpy_32_16_ss( int32_t L_var1, int16_t var2, int32_t *L_varout_h, uint16_t *varout_l) {
   ...
   if( (L_var1 == ( int32_t) 0x80000000)
    && (var2   == ( int16_t) 0x8000)) {
      *L_varout_h = 0x7fffffff;
      *varout_l = ( uint16_t) 0xffff;
      ...
      L40_var1 = (( int64_t) (( int32_t) var2 * ( int32_t) uvar1_l)) << 1;
 ...
 *                the range : 0x8000 0000 <= L_varout_h <= 0x7fff ffff.
 *
 *    *L_varout_l 32 bit short unsigned integer (uint32_t) whose value falls in
...
void Mpy_32_32_ss( int32_t L_var1, int32_t L_var2, int32_t *L_varout_h, uint32_t *L_varout_l) {
   uint16_t uvar1_l, uvar2_l;
   int16_t   var1_h,  var2_h;
   int64_t L40_var1;

   if( (L_var1 == ( int32_t)0x80000000)
    && (L_var2 == ( int32_t)0x80000000)) {
      *L_varout_h = 0x7fffffff;
      *L_varout_l = ( uint32_t)0xffffffff;
      ...
      /* Below line can not overflow, so we can use << instead of L40_shl.  */
      L40_var1 = (( int64_t) (( uint32_t) uvar2_l * ( uint32_t) uvar1_l)) << 1;

      *L_varout_l = 0x0000ffff & L_Extract40( L40_var1);

      L40_var1 = L40_shr( L40_var1, 16);
      L40_var1 = L40_add( L40_var1, (( int64_t) (( int32_t) var2_h * ( int32_t) uvar1_l)) << 1);
      L40_var1 = L40_add( L40_var1, (( int64_t) (( int32_t) var1_h * ( int32_t) uvar2_l)) << 1);
 ...
 *  Purpose :
 *
 *    Assigns a 40 constant to a int64_t with adequate initialization depending
 ...
 *  Inputs :
 *
 *    L40_var1    40 bit long signed integer (int64_t) whose value falls in the
 ...
 *  Return Value :
 *
 *    L40_var_out 40 bit long signed integer (int64_t) whose value falls in
 ...
 *  Return Value :
 *
 *    var_out     16 bit short unsigned integer (uint16_t) whose value falls in
 ...
 *                range : MIN_40 <= L40_var1 <= MAX_40.
 *
 *    L40_var2    40 bit long signed integer (int64_t) whose value falls in the
 ...
 *                the range : MIN_16 <= var2 <= MAX_16.
 *
 *    var3        16 bit short signed integer (int16_t) whose value falls in
 ...
 *  Return Value :
 *
 *    L_var_out   32 bit long unsigned integer (uint32_t) whose value falls in
...
static __inline int64_t L40_shl( int64_t L40_var1, int16_t var2) {
   ...
   int64_t L40_var_out;
#if defined(_MSC_VER) && (_MSC_VER <= 1200)
   int64_t L40_constant = L40_set( 0xc000000000);
#else
   int64_t L40_constant = L40_set( 0xc000000000LL);
#endif
