...
#define FFTC(x) WORD322WORD16((int32_t)x)
...
static void fft5(int32_t *re, int32_t *im, int16_t s)
{
...
static void fft8(int32_t *re, int32_t *im, int16_t s)
{
    int32_t x00, x01, x02, x03, x04, x05, x06, x07;
    int32_t x08, x09, x10, x11, x12, x13, x14, x15;
    int32_t t00, t01, t02, t03, t04, t05, t06, t07;
    int32_t t08, t09, t10, t11, t12, t13, t14, t15;
    int32_t s00, s01, s02, s03, s04, s05, s06, s07;
    int32_t s08, s09, s10, s11, s12, s13, s14, s15;
...
static void fft10(int32_t *re, int32_t *im, int16_t s)
{
    int32_t t;
    int32_t x0, x1, x2, x3, x4;
    int32_t r1, r2, r3, r4;
...
static void fft15(int32_t *re, int32_t *im, int16_t s)
{
    int32_t t;
    int32_t r1, r2, r3, r4;
    int32_t s1, s2, s3, s4;
    int32_t x00, x01, x02, x03, x04, x05, x06, x07, x08, x09;
    int32_t x10, x11, x12, x13, x14, x15, x16, x17, x18, x19;
    int32_t x20, x21, x22, x23, x24, x25, x26, x27, x28, x29;
    int32_t y00, y01, y02, y03, y04, y05, y06, y07, y08, y09;
    int32_t y10, y11, y12, y13, y14, y15, y16, y17, y18, y19;
    int32_t y20, y21, y22, y23, y24, y25, y26, y27, y28, y29;
...
static void fft12(int32_t *pInput)
{
    int32_t  aDst[24];
    int32_t *pSrc, *pDst;
    int32_t i;
    ...
    r2      = Mpy_32_16_asm(L_sub(L_shr_pos(pSrc[8], 2), L_shr_pos(pSrc[16], 2)), C31);
    ...
    s2      = Mpy_32_16_asm(L_sub(L_shr_pos(pSrc[9], 2), L_shr_pos(pSrc[17], 2)), C31);
...
static void fft16(int32_t *re, int32_t *im, int16_t s)
{
    int32_t x0, x1, x2, x3, x4, x5, x6, x7;
    int32_t t0, t1, t2, t3, t4, t5, t6, t7;
    int32_t y00, y01, y02, y03, y04, y05, y06, y07;
    int32_t y08, y09, y10, y11, y12, y13, y14, y15;
    int32_t y16, y17, y18, y19, y20, y21, y22, y23;
    int32_t y24, y25, y26, y27, y28, y29, y30, y31;
...
static void fft20(int32_t *re, int32_t *im, int16_t s)
{
    int32_t r1, r2, r3, r4;
    int32_t s1, s2, s3, s4;
    int32_t x0, x1, x2, x3, x4;
    int32_t t, t0, t1, t2, t3, t4, t5, t6, t7;
    int32_t y00, y01, y02, y03, y04, y05, y06, y07, y08, y09;
    int32_t y10, y11, y12, y13, y14, y15, y16, y17, y18, y19;
    int32_t y20, y21, y22, y23, y24, y25, y26, y27, y28, y29;
    int32_t y30, y31, y32, y33, y34, y35, y36, y37, y38, y39;
...
static void fft30(int32_t *re, int32_t *im, int16_t s)
{
    int32_t t;
    int32_t r1, r2, r3, r4;
    int32_t s1, s2, s3, s4;
    ...
    int32_t z00, z01, z02, z03, z04, z05, z06, z07, z08, z09;
    int32_t z10, z11, z12, z13, z14, z15, z16, z17, z18, z19;
    int32_t z20, z21, z22, z23, z24, z25, z26, z27, z28, z29;
    int32_t z30, z31, z32, z33, z34, z35, z36, z37, z38, z39;
    int32_t z40, z41, z42, z43, z44, z45, z46, z47, z48, z49;
    int32_t z50, z51, z52, z53, z54, z55, z56, z57, z58, z59;

    int32_t *rel, *reh, *iml, *imh;
...
static void fft32(int32_t *re, int32_t *im, int16_t s)
{
    int32_t as, bs;
    int32_t x00, x01, x02, x03, x04, x05, x06, x07;
    int32_t x08, x09, x10, x11, x12, x13, x14, x15;
    ...
    int32_t y16, y17, y18, y19, y20, y21, y22, y23;
    int32_t y24, y25, y26, y27, y28, y29, y30, y31;
    int32_t y32, y33, y34, y35, y36, y37, y38, y39;
    int32_t y40, y41, y42, y43, y44, y45, y46, y47;
    int32_t y48, y49, y50, y51, y52, y53, y54, y55;
    int32_t y56, y57, y58, y59, y60, y61, y62, y63;
...
static void fft40(int32_t *re, int32_t *im, int16_t sx, int32_t *x)
{
    const int32_t *W;
    int16_t        dim1, dim2;
    int32_t       i, j;
    int32_t        x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12, x13, x14, x15;
    int32_t        t00, t01, t02, t03, t04, t05, t06, t07, t08, t09, t10, t11, t12, t13, t14, t15;
    int32_t        s00, s01, s02, s03, s04, s05, s06, s07, s08, s09, s10, s11, s12, s13, s14, s15;
...
static void fftN2(int32_t *re, int32_t *im, const int16_t *W, int16_t dim1, int16_t dim2, int16_t sx, int16_t sc, int32_t *x,
                  int16_t Woff)
{
    int32_t i, j;
...
void LC3_cfft(int32_t *re, int32_t *im, int16_t length, int16_t s, int16_t *scale, int32_t *x)
{
    switch (length)
    {
    case 10:
...
static const int32_t *rfft_twid(int32_t size)
{
    switch (size)
    {
...
void LC3_rfftN(int32_t *x, int16_t sizeOfFft, int16_t *scale, int8_t *scratchBuffer)
{
    int32_t       i;
    int16_t        sizeOfFft2, sizeOfFft4, sizeOfFft8;
    int32_t        t1, t2, t3, t4, xb0, xb1, xt0, xt1;
    int32_t *      workBuffer;
    const int32_t *w32;

    workBuffer = (int32_t *)scratchBuffer; /* Size = 4 * sizeOfFft */
    ...
    LC3_cfft(&x[0], &x[1], sizeOfFft2, 2, scale, workBuffer);
...
void LC3_irfftN(int32_t *x, int16_t sizeOfFft, int16_t *scale, int8_t *scratchBuffer)
{
    int16_t        sizeOfFft2, sizeOfFft4, sizeOfFft8;
    int32_t        t1, t2, t3, t4, xb0, xb1, xt0, xt1;
    int32_t *      workBuffer;
    ...
    workBuffer = (int32_t *)scratchBuffer; /* Size = 2 * LC3_cfft_MAX_LENGTH */
...
static const int32_t kfft_scalefactors[22] = {
    SCALEFACTOR10,
    SCALEFACTOR16,
    SCALEFACTOR20,
    SCALEFACTOR30,
...
static int32_t kfft_idx(int32_t len)
{
    switch (len)
    {
    case 10: return 0;
...
{
    const int32_t numcfg = sizeof(kfft_fft_cfg) / sizeof(*kfft_fft_cfg);
    for (int32_t idx = 0; idx < numcfg; idx++)
    {
...
static void kfft_fft(int32_t *restrict re, int32_t *restrict im, int32_t len, int32_t stride, int32_t rshift,
                     int32_t *restrict scratch)
{
    int32_t idx = kfft_idx(len);
    ...
    for (int32_t i = 0; i < len; i++)
    {
        re[i * stride] = (int32_t)(((Word64)buf[i].r * len) >> rshift);
        im[i * stride] = (int32_t)(((Word64)buf[i].i * len) >> rshift);
    }
}
...
{
    int32_t rshift = kfft_scalefactors[kfft_idx(sizeOfFft)];
    ASSERT_LC3(rshift >= 0);
