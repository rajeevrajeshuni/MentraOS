...
@objc(ERG1Manager) class ERG1Manager: NSObject {
    ...
    @objc func RN_sendDoubleTextWall(_ top: String, _ bottom: String) {
...
extension ERG1Manager {
    ...
    func queueChunks(_ chunks: [[UInt8]], sendLeft: Bool = true, sendRight: Bool = true, sleepAfterMs: Int = 0, ignoreAck: Bool = false) {
    ...
    typealias BmpProgressCallback = (String, Int, Int, Int) -> Void
    typealias BmpSuccessCallback = (String) -> Void
    typealias BmpErrorCallback = (String, String) -> Void

    func displayBitmap(base64ImageData: String,
    ...
    func RN_displayBitmapAnimation(_ framesJson: String, interval: Double, shouldRepeat: Bool) {
        ...
        guard let framesData = framesJson.data(using: .utf8),
              let frames = try? JSONSerialization.jsonObject(with: framesData) as? [String]
        else {
    ...
    @objc func RN_startLocalAnimation() {
    ...
    func displayBitmapFromHex(hexString: String,
                              onProgress: BmpProgressCallback? = nil,
                              onSuccess: BmpSuccessCallback? = nil,
                              onError: BmpErrorCallback? = nil) async -> Bool
    {
    ...
    @objc func RN_displayBmpFromFile(_ filePath: String) {
    ...
    func displayBmpFromFile(filePath: String,
                            onProgress: BmpProgressCallback? = nil,
                            onSuccess: BmpSuccessCallback? = nil,
                            onError: BmpErrorCallback? = nil) async -> Bool
    {
