...
@objc(MentraManager) class MentraManager: NSObject, SherpaOnnxTranscriber.TranscriptDelegate {
  ...
  public func setAuthSecretKey(secretKey: String, userId: String) {
  ...
  public func disconnectWearable() {
  ...
  public func forgetSmartGlasses() {
    disconnectWearable()
    defaultWearable = ""
    deviceName = ""
    g1Manager?.forget()
  ...
  public func handleSearchForCompatibleDeviceNames(_ modelName: String) {
  ...
  public func enableContextualDashboard(_ enabled: Bool) {
    contextualDashboard = enabled
    handleRequestStatus() // to update the UI
    saveSettings()
  }
  
  public func setPreferredMic(_ mic: String) {
    preferredMic = mic
    onMicrophoneStateChange(micEnabled, currentRequiredData, bypassVadForPCM)
    handleRequestStatus() // to update the UI
    saveSettings()
  ...
  public func setButtonMode(_ mode: String) {
  ...
  public func setButtonPhotoSize(_ size: String) {
  ...
  public func setButtonVideoSettings(width: Int, height: Int, fps: Int) {
  ...
  public func setButtonCameraLed(_ enabled: Bool) {
  ...
  public func updateGlassesBrightness(_ value: Int, autoBrightness: Bool) {
  ...
  public func updateGlassesDepth(_ value: Int) {
  ...
  public func updateGlassesHeight(_ value: Int) {
  ...
  public func enableSensing(_ enabled: Bool) {
  ...
  public func enablePowerSavingMode(_ enabled: Bool) {
    powerSavingMode = enabled
    handleRequestStatus() // to update the UI
    saveSettings()
  }
  
  public func enableAlwaysOnStatusBar(_ enabled: Bool) {
    alwaysOnStatusBar = enabled
    saveSettings()
    handleRequestStatus() // to update the UI
  }
  
  public func bypassVad(_ enabled: Bool) {
    bypassVad = enabled
    handleRequestStatus() // to update the UI
    saveSettings()
  }
  
  public func enforceLocalTranscription(_ enabled: Bool) {
  ...
  public func setBypassAudioEncoding(_ enabled: Bool) {
    bypassAudioEncoding = enabled
  }
  
  public func setMetricSystemEnabled(_ enabled: Bool) {
    metricSystemEnabled = enabled
    handleRequestStatus()
    saveSettings()
  }
  
  public func toggleUpdatingScreen(_ enabled: Bool) {
  ...
  public func startVideoRecording(requestId: String, save: Bool) {
    liveManager?.startVideoRecording(requestId: requestId, save: save)
  }
  
  @objc public func stopVideoRecording(requestId: String) {
    liveManager?.stopVideoRecording(requestId: requestId)
  }
  ...
  public func sendWifiCredentials(_ ssid: String, _ password: String) {
  ...
  public func enableGlassesMic(_: Bool) async {
    await g1Manager?.setMicEnabled(enabled: true)
  }
  
  public func handleRequestStatus() {
  ...
  public func handleConnectWearable(_ deviceName: String, modelName: String? = nil) {
